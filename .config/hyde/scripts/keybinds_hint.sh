...
r_listview="listview { lines: ${kb_hint_line:-13}; scroll-method: 1; fixed-height: true; }"
...
font_override="* {font: \"${font_name:-"JetBrainsMono Nerd Font"} $font_scale\"; scroll-method: 1;}"
